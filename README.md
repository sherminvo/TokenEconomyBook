...
Japanese: is currently being translated by a team in Japan and published in a separate Github Repository: https://github.com/Naokiakazawa/TokenEconomyBook_JP/wiki
...
Portugese: currently being translated by António Chagas, Courtnay Guimaraes, Jose Rui Sousa and Joana Camilo and will be published in a separate Github Repository soon. 
...
Chinese: currently being coordinated and translated by Joanne Long.
...
Catalan: coordinate with Marc Rocas marc@blockchaincatalunya.org

Spanish: coordinate with martin.bertoni@ucc.edu.ar and Sebastián Heredia Querro herediaquerro.mde@ucc.edu.ar
